    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        public void GetFacesList()
        {
            ...
            if(!File.Exists(Config.HaarCascadePath))
            {
                ...
                MessageBoxResult result = MessageBox.Show(text, "Error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
            ...
            // Create empty dirtory / file for face data if it doesn't exist
            ...
            {
                string text = "Cannot fine face data file:\n\n";
                text += Config.FaceListTextFile + "\n\n";
                text += "If this is your first time running the app, an empty file will be created for you.";
                MessageBoxResult result = MessageBox.Show(text, "Warning", MessageBoxButton.OK, MessageBoxImage.Warning);
                switch(result)
                {
